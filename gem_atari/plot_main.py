...
if __name__=='__main__':
	...
	CI_level = 0.6
	dir_List = [
		('paper/main_sticky/alien-rews', 10000000),
		('paper/main_sticky/bankheist-rews', 5000000),
		('paper/main_sticky/battlezone-rews', 10000000),
		('paper/main_sticky/frostbite-rews', 10000000),
		('paper/main_sticky/mspacman-rews', 10000000),
		('paper/main_sticky/roadrunner-rews', 5000000),
		('paper/main_sticky/stargunner-rews', 30000000),
		('paper/main_sticky/wizardofwor-rews', 10000000),
		('paper/main_sticky/zaxxon-rews', 15000000),
	]
	lines = []
	...
	plt.savefig('plot_data/paper/main_sticky/main_sticky.pdf', bbox_inches='tight')
	plt.close()
